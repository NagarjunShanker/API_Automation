...
public class ComplexJsonResponse extends BaseClass {
	...
	public static void main(String[] args) {
		...
		String validateCourseName = "Ruby";
		...
		for (int i = 0; i < jp.getList("courses").size(); i++) {
			...
			sumPrice = sumPrice + (Integer.parseInt(jp.getString("courses.price[" + i + "]"))
					* Integer.parseInt(jp.getString("courses.copies[" + i + "]")));
		}
